...
decoder.load_state_dict(torch.load("C:/Users/user/Desktop/ASHISH/Prime Classes/Major Projects/NST_Code/experiment/final_exp/decoder_final.pth"))
encoder.eval()
decoder.eval()
